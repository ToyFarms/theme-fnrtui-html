...
function addEventListeners() {
    ...
    const downloadButtons = Array.from(downloadBtns).filter(btn => 
        btn.textContent.includes('Download') || btn.textContent.includes('Upgrade Now')
    );
...
function showNotification(message, type = 'info', duration = 3000) {
    ...
    notification.className = `fixed top-4 right-4 px-6 py-3 rounded-lg shadow-lg z-50 ${typeClasses[type]} fade-in`;
